...
session_start();
$acc_username = "IanReniel";
$acc_password = "ReyIan03";
$acc_fullname = "Ian Reniel R. Rey";
$acc_address = "Brgy. Bagong Silang Santa Cruz Marinduque";
				...
				<div class="col-md-6 col-lg-5">
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
		      		...
		      		<div class="form-group">
		      			...
		      			echo "<div  class='alert alert-info' role = 'alert'>< You are still logged in.<a href= 'account.php'> click here to proceed.<a/></div>";
